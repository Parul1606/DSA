package com.naukri.notification_api.services;
...
public class CompanyService {
    ...
    /**
     * To SendEmail to the user we require javamailsender object.
     * @return
     */
    public JavaMailSenderImpl getJavaMailSender(){
        ...
        javaMailSender.setPassword("relcfdwhahhcvokv"); // AppPassword of my gmail
